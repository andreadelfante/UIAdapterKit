//
//  ArrayCollectionViewAdapter.swift
//  UIAdapterKit
//
...
open class ArrayCollectionViewAdapter: BaseCollectionViewAdapter {
    internal var sections: [BaseCollectionViewSection]
    ...
    open func append<T>(section: ArrayCollectionViewSection<T>) {
    ...
    @discardableResult
    open func insert<T>(section: ArrayCollectionViewSection<T>, at index: Int) -> Bool {
    ...
    @discardableResult
    open func replace<T>(section: ArrayCollectionViewSection<T>, at index: Int) -> Bool {
        guard 0 <= index && index < sectionCount else { return false }
