//
//  ArraySearchableCollectionViewAdapterTests.swift
//  UIAdapterKit_Tests
//
...
class ArraySearchableCollectionViewAdapterTests: XCTestCase {
    private var faker: Faker!
    private var models: [BasicModel]!
    private var section: BMCollectionViewSection!
    private var adapter: ArraySearchableCollectionViewAdapter!
    ...
    override func setUp() {
        ...
        section = BMCollectionViewSection(items: models, itemBuilder: { BasicCollectionViewItem($0) })
        adapter = ArraySearchableCollectionViewAdapter()
    }
...
fileprivate class BMCollectionViewSection: ArrayCollectionViewSection<BasicModel> {
